...
export default function MeditronAI() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-900 p-6 pt-24 text-white">
      <h1 className="text-3xl font-bold text-rose-500 mb-4">MeditronAI - Diagnosis Assistant</h1>
      ...
      <Card className="w-full max-w-3xl bg-neutral-800 border border-neutral-700 shadow-lg p-6 rounded-xl">
        <CardContent>
          <Textarea
            ...
            className="w-full h-40 p-3 bg-neutral-900 border border-neutral-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-rose-500"
            value={symptoms}
            onChange={(e) => setSymptoms(e.target.value)}
          />
          <div className="flex justify-end mt-4">
            <Button onClick={handleGenerate} className="bg-rose-600 hover:bg-rose-500 transition px-6">
      ...
      {analysis && (
        <Card className="w-full max-w-3xl bg-neutral-800 border border-neutral-700 shadow-lg p-6 mt-6 rounded-xl animate-fade-in">
          <CardContent>
            <h2 className="text-2xl font-semibold text-rose-500">Predicted Condition</h2>
            <p className="text-lg text-white mt-2">{analysis.condition}</p>
            <h3 className="text-xl font-semibold text-rose-400 mt-4">Explanation</h3>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Button onClick={handleDownload} className="bg-rose-600 hover:bg-rose-500 flex items-center gap-2 px-6">
