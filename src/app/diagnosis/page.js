  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-900 text-white p-6">
      <Card className="w-full max-w-2xl p-6 shadow-lg border rounded-xl bg-neutral-800">
        <CardHeader className="text-xl font-semibold text-rose-500 flex items-center gap-2">
          <FileText className="h-6 w-6 text-rose-500" /> Diagnosis Analysis
        </CardHeader>
        <CardContent className="flex flex-col gap-4">
          <div className="flex flex-col items-center gap-4">
            <label className="flex flex-col items-center justify-center w-full border-2 border-dashed border-rose-500 p-6 rounded-lg cursor-pointer bg-neutral-700 hover:bg-neutral-600">
          ...
          <Button onClick={handleAnalyze} disabled={!selectedFile} className="bg-rose-500 w-full">
            Analyze Scan
          </Button>
          {aiReport && (
            <div className="p-4 bg-neutral-700 rounded-lg border border-rose-500 text-white">
              <p className="text-lg font-semibold text-rose-500">AI Diagnosis Report</p>
              <p className="text-sm">{aiReport.result}</p>
              <p className="text-sm">Confidence Level: {aiReport.confidence}</p>
            </div>
          )}
          <Button className="bg-rose-500 w-full flex items-center gap-2">
